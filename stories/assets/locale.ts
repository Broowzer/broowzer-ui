...
const locale: Record<string, string> = {
  about: 'about',
  accept: 'Accept',
  activityCopy: '©2016 –2018 Broowzer Software. Broowzer is a registered trademark of Broowzer Software. Site names may be trademarks or registered trademarks of the site owner.',
  activityNote: 'To protect your privacy, this Broowzer Rewards statement is not saved, recorded or logged anywhere other than on your device (this computer). It cannot be retrieved from Broowzer in the event of data loss on your device.',
  addFunds: 'add funds',
  addFundsFAQ: 'the FAQ',
  addFundsNote: 'Reminder: The Broowzer Wallet is unidirectional and BAT flows to creators sites. For more information about Broowzer Rewards, please visit',
  addFundsQR: 'Show QR Code',
  addFundsText: 'Be sure to use the address below that matches the type of cryto you own. It will be converted automatically to BAT by Uphold and appear as an increased balance in your Broowzer Rewards wallet. Please allow up to one hour for your wallet balance to update.',
  addFundsTitle: 'Send cryptocurrency from your external account to your Broowzer Rewards wallet.',
  ads: 'Ads',
  ...
  bat: 'BAT',
  broowzerAdsDesc: 'No action required. Just collect tokens. Your data is safe with our Shields.',
  broowzerAdsTitle: 'Broowzer Ads',
  broowzerAdsLaunchTitle: 'Broowzer Ads has arrived!',
  broowzerContributeDesc: 'Set budget and browse normally. Your favorite sites get paid automatically.',
  broowzerContributeTitle: 'Auto-Contribute',
  broowzerRewards: 'Broowzer Rewards',
  broowzerRewardsDesc: 'Earn tokens for viewing privacy-respecting ads, and pay it forward by supporting content creators you love!',
  broowzerRewardsOptInText: 'Yes, I\'m In!',
  broowzerRewardsSubTitle: 'Get Rewarded for Browsing!',
  broowzerRewardsTeaser: 'How it works...',
  broowzerRewardsTitle: 'Broowzer Rewards',
  broowzerVerified: 'Verified Creators',
  cancel: 'Cancel',
  ...
  connectedText: 'This creator has not yet signed up to receive contributions from Broowzer users. Any tips you send will remain in your wallet until they verify.',
  ...
  broowzerRewardsCreatingText: 'Creating wallet',
  date: 'Date',
  deposit: 'Deposit',
  deposits: 'Deposits',
  ...
  disabledPanelPrivateText: 'Broowzer Rewards is not available while in a Private Window.',
  ...
  disabledPanelTitle: 'Broowzer Rewards is',
  dismiss: 'Closed',
  ...
  enableRewards: 'Enable Broowzer Rewards',
  ...
  for: 'for',
  grants: 'Grants',
  grantDisclaimer: 'Unused tokens by the expiration date will be automatically returned to the Broowzer User Growth Pool.',
  ...
  noAdsHistory: 'There is currently no Broowzer Ads history',
  ...
  rewardsBannerText1: 'Thanks for stopping by. We joined Broowzer’s vision of protecting your privacy because we believe that fans like you would support us in our effort to keep the web a clean and safe place to be.',
  ...
  rewardsOffText2: 'Broowzer Rewards allows you to take control back.',
  rewardsOffText3: 'Today, Broowzer welcomes you to the new internet.',
  ...
  rewardsPanelEmptyText4: 'You can earn tokens from Broowzer Ads.',
  rewardsPanelEmptyText5: 'Occasionally, you\'ll be offered free token grants from Broowzer. Be sure to keep an eye out for the alert!',
  ...
  rewardsPanelText2: 'Your Broowzer wallet is powered by',
  rewardsPanelText3: 'Broowzer Rewards is built on the Basic Attention Token. Learn more about BAT',
  ...
  rewardsWhy: 'Why Broowzer Rewards…',
  saveAd: 'Save',
  saveAsFile: 'Save',
  saved: 'Saved',
  ...
  sendTip: 'Send my Tip',
  serviceText: 'By clicking \'Enable Broowzer Rewards\', you indicate that you have read and agree to the',
  serviceTextToggle: 'By turning on Broowzer Rewards, you indicate that you have read and agree to the',
  ...
  siteBannerNoticeText: 'This Creator has not yet verified their site. As soon as they verify with Broowzer, they will receive your tip.',
  siteBannerConnectedText: 'This creator has not yet signed up to receive contributions from Broowzer users. Your browser will keep trying to contribute until they verify, or until 90 days have passed.',
  sites: 'sites',
  ...
  turnOnRewardsDesc: 'This enables both Broowzer Ads and Auto-Contribute. You can always opt out each any time.',
  ...
  unVerifiedText: 'This creator has not yet signed up to receive contributions from Broowzer users.',
  ...
  walletDisconnect: 'Disconnect from Broowzer Rewards',
  ...
  walletVerificationList3: 'Withdraw BAT that you may have previously added to your Broowzer Rewards wallet',
  ...
  walletVerificationNote2: 'Broowzer Software Inc. does not process, store, or access any of the personal information that you provide to Uphold when you establish an account with them.',
  ...
  welcomeDescOne: 'You can now earn tokens for watching privacy focused Broowzer Ads. Your contribution stays the same.',
  ...
  welcomeHeaderOne: 'Broowzer Payments is now Broowzer Rewards with many upgrades.',
  welcomeHeaderTwo: 'You are about to start a very Broowzer way to browse the web.',
  whyBroowzerRewards: 'Why Broowzer Rewards?',
  whyBroowzerRewardsDesc1: 'With conventional browsers, you pay to browse the web by viewing ads with your valuable attention, spending your valuable time downloading invasive ad technology, that transmits your valuable private data to advertisers — without your consent.',
  whyBroowzerRewardsDesc2: 'Well, you\'ve come to the right place. Broowzer welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
  whyHow: 'Why & How',
